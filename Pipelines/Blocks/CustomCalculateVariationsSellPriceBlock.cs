...
{
    class CustomCalculateVariationsSellPriceBlock : CalculateVariationsSellPriceBlock
    {
        public CustomCalculateVariationsSellPriceBlock(CommerceCommander commander)
            : base(commander)
        {
        }
